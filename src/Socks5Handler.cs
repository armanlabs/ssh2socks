...
/// <summary>
/// پارس کردن پروتکل SOCKS5 طبق RFC 1928
/// </summary>
public class Socks5Handler
{
    ...
    public static async Task NegotiateAuthAsync(NetworkStream stream, CancellationToken ct)
    {
        ...
        // بررسی اینکه آیا no-auth رو قبول داره
    ...
    /// <summary>
    /// مرحله دوم: خواندن درخواست اتصال از کلاینت
    /// </summary>
    ...
    /// <summary>
    /// خواندن دقیقاً N بایت از stream
    /// </summary>
